...
export const metadata: Metadata = {
  ...
  description:
    "Pixalara is a premium digital agency specializing in Web Design, App Development, Branding, and Cloud Solutions. We build digital products for global brands.",
